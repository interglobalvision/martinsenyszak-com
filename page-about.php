...
?>
    ...
    <article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
      ...
      <section id="about-page-pullquote" class="grid-row">
        <div class="grid-item item-s-12 item-m-10 offset-m-1 item-l-8 offset-l-2 padding-top-large padding-bottom-large text-align-center font-size-large pull-quote">
          <?php echo $pullquote; ?>
        </div>
      </section>
      <?php
